...
export default async function handler(req, res) {
    ...
    if (text.startsWith('/start')) {
        ...
        if (!ch || !com) {
            await tgSendPhoto(chatId, COVER_PHOTO,
                `🎬 <b>স্বাগতম NEWTUBE-তে!</b>\n\n` +
                `ভিডিও দেখে ফ্রি ক্রিপ্টো (WTC → TON/USDT) আয় করুন — কোনো বিনিয়োগ লাগবে না! 💰\n\n` +
                `⚠️ শুরু করার আগে আমাদের official channel ও community-তে join করা বাধ্যতামূলক।`,
                { reply_markup: { inline_keyboard: [
        ...
        await tgSendPhoto(chatId, COVER_PHOTO,
            ...
            `💰 TON ও USDT-তে সরাসরি withdraw\n` +
            `👥 ফ্রেন্ড রেফার করে বোনাস WTC\n` +
            `🎁 কোনো investment ছাড়াই সম্পূর্ণ ফ্রি আয়\n\n` +
