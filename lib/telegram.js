...
// ⚠️ NEW — public proof-of-payment channel (shared with Fruit Cut:
// https://t.me/fruit_cut_payment, currently named "Fruit cut X Newtube payment").
// Was never wired up on the NEWTUBE side — approvals only DMed the user and
// edited the admin chat, nothing was ever posted here. See api/bot.js wd_approve_.
export const PAYMENT_CHANNEL = '@fruit_cut_payment';
