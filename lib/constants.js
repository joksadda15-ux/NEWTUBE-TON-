...
// Current month key in the Bangladesh timezone (e.g. "07/2026") — used to
// reset the tiered-withdraw monthly claim counters below.
...
//
//   - `usd` is the GROSS amount deducted (converted to WTC at WTC_PER_USD).
//     The 25% withdraw fee still applies on top, same as before — the net
//     payout the user actually receives is shown separately in the UI.
//   - `monthlyLimit` — how many times THIS tier can be claimed, resets at
//     the start of each calendar month (Bangladesh time).
