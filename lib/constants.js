...
export const REFERRAL_REWARDS = {
    step1_verified:      23,  // when the referred user joins channel+community and verifies (was 30)
    step2_tenTasks:      45,  // when the referred user completes 10 tasks (was 60)
    step3_twentyAds:     98,  // when the referred user completes 20 ads (was 130)
};
