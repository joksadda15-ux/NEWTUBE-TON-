...
export const WITHDRAW_ADS_REQUIRED = 8; // ⚠️ CHANGED — was 15, lowered per admin's decision (15 felt excessive on top of the ads users already watch to earn WTC in the first place)
...
// ══════════════════════════════════════════════════════════
export const WITHDRAWALS_OPEN = false;
