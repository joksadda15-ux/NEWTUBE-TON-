...
export const AD_NETWORK_REWARDS = {
    ...
    // ⚠️ NEW — TADS (tads.me), widget #11933, TGB/static banner format. Reward
    // and cap kept deliberately low/tight — see handleClaimTadsClick in
    // api/earn.js for why this network has a weaker anti-abuse guarantee
    // than the other four (no server-anchored "start" token possible for a
    // passive click-reward banner). ASSUMED VALUES — confirm/adjust these.
    tads:           { reward: 5, dailyLimit: 5 },
};
