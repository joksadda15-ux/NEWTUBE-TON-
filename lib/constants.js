// lib/constants.js — SEASON 2 আপডেট (FIXED RATES — লাইভ প্রাইস বাতিল করা হয়েছে)
//
// ⚠️ Admin-এর নির্দেশে লাইভ TON প্রাইস সিস্টেম বাদ দেওয়া হয়েছে — সেটা
// মাঝে মাঝে বাজার-দাম কম থাকলে ইউজারকে বেশি TON দিয়ে ফেলতো। এখন আবার
// সহজ, পূর্বনির্ধারিত (fixed) রেট ব্যবহার হচ্ছে — প্রেডিক্টেবল payout,
// কোনো external API-নির্ভরতা নেই।
//
// Gold + Diamond দুই-স্তর কারেন্সি বাদ দিয়ে এখন একটাই কারেন্সি — WTC coin।
// সব reward/fee/withdraw সংখ্যা এখানে।

export const CURRENCY = 'WTC';

// ── WTC থেকে আসল টাকায় কনভার্শন রেট (FIXED) ──
...
// ── Withdraw methods (bKash নেই) — এখন দুটোই fixed রেট, live fetch নেই ──
...
export const WITHDRAW_MIN_WTC = {
    ...
    tonkeeper: 1200, // আগের মতোই রাখা হয়েছে
};
