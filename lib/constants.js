...
export const LOOTBOX_CLAIM_MIN = 50;         // ক্লেইম করার জন্য মিনিমাম জমা থাকতে হবে
...
export const DAILY_VIDEO_WATCH_HOURS_MAX = 10;
export const DAILY_VIDEO_WTC_MAX = DAILY_VIDEO_WATCH_HOURS_MAX * 60; // = 600 WTC/day
